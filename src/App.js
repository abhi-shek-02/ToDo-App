...
function App() {
  ...
  return (
    <div className="App">
      ...
      <div>
        {/* INPUT */}
        <input type="text" className="input" placeholder="Enter Your Task .." onChange={(e) => functin(e)} />
        <button onClick={() => submition()} className="button-9">Submit</button>
        {
          list.map((item, index) => {
            return (
              <div className="list-containers">
                <div className="list-items-main" >
                  ...
                  <div className="list-btn-container">
                    {/* {console.log(index)} */}
                    <button className="button-11" onClick={(index) => deletelist(index)}>Done</button>
                  </div>
                </div>
              </div>
            )
